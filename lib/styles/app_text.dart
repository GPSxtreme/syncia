...
class AppText {
  ...
  static TextStyle get textXs => TextStyle(fontSize: _textXsSize, height: 1.16);
  static TextStyle get textSm => TextStyle(fontSize: _textSmSize, height: 1.20);
  static TextStyle get textBase =>
      TextStyle(fontSize: _textBaseSize, height: 1.24);
  static TextStyle get textLg => TextStyle(fontSize: _textLgSize, height: 1.28);
  static TextStyle get textXl => TextStyle(fontSize: _textXlSize, height: 1.28);
  static TextStyle get text2Xl =>
      TextStyle(fontSize: _text2XlSize, height: 1.32);
  static TextStyle get text3Xl =>
      TextStyle(fontSize: _text3XlSize, height: 0.9);
  static TextStyle get text4Xl =>
      TextStyle(fontSize: _text4XlSize, height: 0.9);
  static TextStyle get text5Xl =>
      TextStyle(fontSize: _text5XlSize, height: 0.8);
  static TextStyle get text6Xl =>
      TextStyle(fontSize: _text6XlSize, height: 0.8);
  static TextStyle get text7Xl =>
      TextStyle(fontSize: _text7XlSize, height: 0.7);
